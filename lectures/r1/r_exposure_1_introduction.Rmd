...
date: "Apr 3, 2022<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
No matter how long the chain of functions is, assignment is done at the top.<sup>1</sup>
...
It works just like `%>%` but is sometimes faster.

It cannot, however, pipe anywhere but the first argument:
