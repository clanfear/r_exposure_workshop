...
date: "Apr 17, 2022<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
```{r, eval=!file.exists("../../data/billboard.csv"), echo = TRUE, warning=FALSE, message=FALSE}
...
.small[
```{r, eval = file.exists("../../data/billboard.csv"), echo=FALSE, warning=FALSE, message=FALSE}
