---
title: "R Exposure 2"
subtitle: "Data Visualization and Management"  
author: "Charles Lanfear"
date: "Oct 24, 2021<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
1. [Download and work from the R script](https://clanfear.github.io/r_exposure_workshop/lectures/r2/r_exposure_2_intermediate.R)<sup>1</sup>

2. [Download the entire series as a Zip](https://github.com/clanfear/r_exposure_workshop/zipball/master)

   * Unzip to a folder
   * Open the RStudio project file

.footnote[[1] This is the easiest!]
...
.center[
<img src="img/ggplot2_logo.png" style="width: 45%;"/>
]
...
When you knit an R Markdown file, any plots you make are automatically saved in at "[RMD filename]_files/figure-[format]/". If you want to save another copy (perhaps of a different file type for use in a manuscript), use `ggsave()`:
...
These new variables are calculated using *all rows* in `yugoslavia` in 1982.
...
For more sophisticated conversion or pattern checking, you'll need to use string parsing (to be covered in R4).
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE, fig.height=4, dev='png', dpi=600}
